...
class CustomColorSchemeMdl extends ThemeExtension<CustomColorSchemeMdl> {
  const CustomColorSchemeMdl({
  ...
  @override
  CustomColorSchemeMdl lerp(ThemeExtension<CustomColorSchemeMdl>? other, double t) {
  ...
  static CustomColorSchemeMdl of(BuildContext context) {
    return Theme.of(context).extension<CustomColorSchemeMdl>()!;
  }
}
